...
factoryController.processLogin = async (req: AdminRequest, res: Response) => {
    try {
...
factoryController.logout = async (req: AdminRequest, res: Response) => {
     try {
        console.log("logout")
...
factoryController.getUsers = async (req: Request, res: Response) => {
    try {
...
factoryController.checkAuthSession = async (req: AdminRequest, res: Response) => {
    try {
